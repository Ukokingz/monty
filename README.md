...
- The repository monty should be added as a submodule to your alx-school-low_level_programming repository, under the name 0x18-stacks_queues_lifo_fifo
...
### Advanced Tasks
* opcodes: sub, div, mul, mod, comments, pchar, pstr, rotl, rotr, stack, queue, alx, Add two digits, Multiplication, Multiplication level up

---

## Authors
* **Uko Iheanyi** - (https://github.com/uiking001)
* **Onwukwe Uko** - (https://github.com/ukokingz)
